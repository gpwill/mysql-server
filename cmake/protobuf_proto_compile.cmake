...
FUNCTION(MYSQL_PROTOBUF_GENERATE_CPP GENERATED_SOURCE GENERATED_HEADERS)
  ...
  IF(GENERATE_GRPC_OUTPUT_DIRECTORY)
    LIST(APPEND PROTOC_ADDITION_OPTIONS "--grpc_out=${GENERATE_GRPC_OUTPUT_DIRECTORY}")
    LIST(APPEND PROTOC_ADDITION_OPTIONS "--plugin=protoc-gen-grpc=$<TARGET_FILE:grpc_cpp_plugin>")
  ENDIF()
  ...
  FOREACH(PROTO_FILE ${PROTO_FILES})
    ...
    IF(GENERATE_GRPC_OUTPUT_DIRECTORY)
      LIST(APPEND GENERATED_CC_FILE "${GENERATE_GRPC_OUTPUT_DIRECTORY}/${WITHOUT_DIR_AND_EXT_PROTO_FILE}.grpc.pb.cc")
      LIST(APPEND GENERATED_H_FILE "${GENERATE_GRPC_OUTPUT_DIRECTORY}/${WITHOUT_DIR_AND_EXT_PROTO_FILE}.grpc.pb.h")
    ENDIF()
